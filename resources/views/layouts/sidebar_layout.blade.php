<div x-data="{ sidebarOpen: false }" class="flex h-screen bg-[#F8FAFC] dark:bg-gray-900 overflow-hidden font-sans antialiased selection:bg-indigo-100 selection:text-indigo-600">
    ...
    <h4 class="px-4 text-[9px] font-black text-gray-400 uppercase tracking-[0.3em] mt-8 mb-4">Ujian</h4>
    <x-nav-link-sidebar :href="route('guru.ujians.index')" :active="request()->routeIs('guru.ujians.*')" icon="M9 12h6m-3-3v6">Ujian</x-nav-link-sidebar>
@endif
</nav>
